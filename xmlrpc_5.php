<?php
/** some changes made by Herbert Roider
because of the php.ini flag: allow_call_time_pass_reference
Therefore this script is only used for the output, but no more for parsing the xml
*/
/*
