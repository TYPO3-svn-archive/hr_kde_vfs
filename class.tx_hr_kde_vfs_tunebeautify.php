...
*
*!!!!!!!!!!
*modified by Herbert Roider <herbert.roider@utanet.at> mainly because of the whitespaces at the end of they
*closing php-tag.
*
*
 ...
 *
 */
class tx_hr_kde_vfs_tune_phpBeautify extends PEAR {
	//public variables
	/**
	* Spaces to indent
	* @var int
...
*/
	 ...
	 *
	 */
class tx_hr_kde_vfs_tuneBeautify extends tx_hr_kde_vfs_tune_phpBeautify {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/hr_kde_vfs/class.tx_hr_kde_vfs_tunebeautify.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/hr_kde_vfs/class.tx_hr_kde_vfs_tunebeautify.php']);
}
?>